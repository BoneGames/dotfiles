...
# Clone large dotfiles and those that require post install (Jackson)
...
# Clone large dotfiles and those that require post install (Ben)
vcsh clone https://bonegames@github.com/bonegames/dotfiles-zsh.git &
